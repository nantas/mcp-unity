...
namespace McpUnity.Unity
{
    ...
    public class McpUnitySocketHandler : WebSocketBehavior
    {
        ...
        public static JObject CreateErrorResponse(string message, string errorType, JObject details = null) =>
            McpUnityResponseUtils.CreateErrorResponse(message, errorType, details);
        ...
        public static JObject CreateBusyResponse(string activeOperation, string activeClientName) =>
            McpUnityResponseUtils.CreateBusyResponse(activeOperation, activeClientName);
        ...
        public static JObject CreateProjectHandshakeResponse(string expectedWorkspacePath, string unityProjectPath) =>
            McpUnityResponseUtils.CreateProjectHandshakeResponse(expectedWorkspacePath, unityProjectPath);

        public static string GetCurrentProjectPath() =>
            McpUnityResponseUtils.GetCurrentProjectPath();

        public static string NormalizeProjectPath(string projectPath) =>
            McpUnityResponseUtils.NormalizeProjectPath(projectPath);

        public static bool PathsMatch(string expectedPath, string actualPath, bool caseInsensitive = false) =>
            McpUnityResponseUtils.PathsMatch(expectedPath, actualPath, caseInsensitive);
